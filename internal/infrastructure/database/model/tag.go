...
type Tag struct {
	BaseModel
	DeletedAt int64  `json:"deleted_at" gorm:"column:deleted_at;uniqueIndex:idx_name_deleted_at;comment:删除时间，默认为0"`
	...
	Slug      string `json:"slug" gorm:"column:slug;not null;comment:简写"`
}
