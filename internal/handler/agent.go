...
//	@return rsp *huma.StreamResponse
//	@return err error
//	@author centonhuang
//	@update 2025-11-11 04:20:38
func (h *agentHandler) HandleChat(ctx context.Context, req *dto.ChatReq) (rsp *huma.StreamResponse, err error) {
