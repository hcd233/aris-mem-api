...
type SSEResponse struct {
	DataType enum.SSEDataType `json:"dataType" enum:"message,error,heartbeat,none" doc:"Data type"`
	Status   enum.SSEStatus   `json:"status" enum:"start,streaming,error,end" doc:"Status"`
